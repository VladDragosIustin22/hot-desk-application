...
namespace HotDeskApplicationApi.Data
{
	public class HotDeskDbContext : IdentityDbContext
	{
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                new Desk  { ID = Guid.Parse(PP1), Name = "PP1", FloorID = Guid.Parse(PGroundFloor), OfficeID = Guid.Parse(PredealID) },
                new Desk  { ID = Guid.Parse(PP2), Name = "PP2", FloorID = Guid.Parse(PGroundFloor), OfficeID = Guid.Parse(PredealID) },
                new Desk  { ID = Guid.Parse(PP3), Name = "PP3", FloorID = Guid.Parse(PGroundFloor), OfficeID = Guid.Parse(PredealID) },
                new Desk  { ID = Guid.Parse(PP4), Name = "PP4", FloorID = Guid.Parse(PGroundFloor), OfficeID = Guid.Parse(PredealID) },
                new Desk  { ID = Guid.Parse(PP5), Name = "PP5", FloorID = Guid.Parse(PGroundFloor), OfficeID = Guid.Parse(PredealID) },
                new Desk  { ID = Guid.Parse(PE11), Name = "PE11", FloorID = Guid.Parse(PFloor1), OfficeID = Guid.Parse(PredealID) },
                new Desk  { ID = Guid.Parse(PE12), Name = "PE12", FloorID = Guid.Parse(PFloor1), OfficeID = Guid.Parse(PredealID) },
                new Desk  { ID = Guid.Parse(PE13), Name = "PE13", FloorID = Guid.Parse(PFloor1), OfficeID = Guid.Parse(PredealID) },
                new Desk  { ID = Guid.Parse(PE14), Name = "PE14", FloorID = Guid.Parse(PFloor1), OfficeID = Guid.Parse(PredealID) },
                new Desk  { ID = Guid.Parse(PE21), Name = "PE21", FloorID = Guid.Parse(PFloor2), OfficeID = Guid.Parse(PredealID) },
                new Desk  { ID = Guid.Parse(PE22), Name = "PE22", FloorID = Guid.Parse(PFloor2), OfficeID = Guid.Parse(PredealID) },
                new Desk  { ID = Guid.Parse(PE23), Name = "PE23", FloorID = Guid.Parse(PFloor2), OfficeID = Guid.Parse(PredealID) },
                new Desk  { ID = Guid.Parse(PE24), Name = "PE24", FloorID = Guid.Parse(PFloor2), OfficeID = Guid.Parse(PredealID) },
                new Desk  { ID = Guid.Parse(BE13), Name = "BE13", FloorID = Guid.Parse(BFloor1), OfficeID = Guid.Parse(BrizeiID) },
                new Desk  { ID = Guid.Parse(BE14), Name = "BE14", FloorID = Guid.Parse(BFloor1), OfficeID = Guid.Parse(BrizeiID) },
                new Desk  { ID = Guid.Parse(BE21), Name = "BE21", FloorID = Guid.Parse(BFloor2), OfficeID = Guid.Parse(BrizeiID) },
                new Desk  { ID = Guid.Parse(BE22), Name = "BE22", FloorID = Guid.Parse(BFloor2), OfficeID = Guid.Parse(BrizeiID) },
                new Desk  { ID = Guid.Parse(BE23), Name = "BE23", FloorID = Guid.Parse(BFloor2), OfficeID = Guid.Parse(BrizeiID) },
                new Desk  { ID = Guid.Parse(BE24), Name = "BE24", FloorID = Guid.Parse(BFloor2), OfficeID = Guid.Parse(BrizeiID) },
             };
