            ...
            <Grid container spacing={2}>
              <Grid item xs={12} sm={6}>
                <TextField
                  ...
                  required
                  fullWidth
                  value={formik.touched.firstName}
                  id="firstName"
                  label="First Name"
                  autoFocus
              ...
              <Grid item xs={12}>
                <TextField
                  required
                  fullWidth
                  value={formik.touched.confirmPassword}
